...
def main():
    ...
    def draw_game_over():
        ...
        font_text = pygame.font.Font('LECO.ttf', curr_main_width // 13)
        ...
        font_score = pygame.font.Font('LECO.ttf', curr_main_width // 15)
    ...
    def draw_score():
        ...
        font_highest = pygame.font.Font('LECO.ttf', int(grid_padding / 2))
        ...
        font_score = pygame.font.Font('LECO.ttf', int(grid_padding / 1.3))
    ...
    def draw_combos():
        ...
        for i in range(len(combos[0]) - 1, -1, -1):
            ...
            font_combo = pygame.font.Font('LECO.ttf', font_size)
